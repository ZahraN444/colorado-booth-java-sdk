 ...
 */
public class OAuthACGManager extends HeaderAuth implements OAuthACGCredentials {
     ...
     */
    private OAuthACGModel authModel;

    /**
     * Constructor.
     */
    public OAuthACGManager(OAuthACGModel authModel) {
    ...
    */
    ...
    /**
     * List of OAuthScopeOAuthACGEnum value for oAuthScopes.
     * @return oAuthScopes
     */
    public List<OAuthScopeOAuthACGEnum> getOAuthScopes() {
     ...
     * @param oAuthScopes List of OAuthScopeOAuthACGEnum value for credentials.
     * @return true if credentials matched.
     */
    public boolean equals(String oAuthClientId, String oAuthClientSecret, String oAuthRedirectUri,
            OAuthToken oAuthToken, List<OAuthScopeOAuthACGEnum> oAuthScopes) {
    ...
    /**
     * Converts this OAuthACGManager into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "OAuthACGManager [" + "oAuthClientId=" + getOAuthClientId() + ", oAuthClientSecret="
                + getOAuthClientSecret() + ", oAuthRedirectUri=" + getOAuthRedirectUri()
                + ", oAuthToken=" + getOAuthToken() + ", oAuthScopes=" + getOAuthScopes() + "]";
    }
    ...
    public String buildAuthorizationUrl(final String state,
        ...
        queryBuilder.append("/oauth/authorize");
    ...
    public CompletableFuture<OAuthToken> fetchTokenAsync(final String authorizationCode,
        ...
        return oAuthApi.requestTokenOAuthACGAsync(
    ...
    public OAuthToken fetchToken(String authorizationCode, Map<String, Object> additionalParameters)
        ...
        final Map<String, Object> aparams =
                additionalParameters == null ? new HashMap<String, Object>() : additionalParameters;
        OAuthToken token = oAuthApi.requestTokenOAuthACG(
            getBasicAuthForClient(),
            authorizationCode,
            getOAuthRedirectUri(),
            aparams);
    ...
    public CompletableFuture<OAuthToken> refreshTokenAsync(
        ...
        final Map<String, Object> aparams =
                additionalParameters == null ? new HashMap<String, Object>() : additionalParameters;
        return oAuthApi.refreshTokenOAuthACGAsync(
            getBasicAuthForClient(),
    ...
    public OAuthToken refreshToken(final Map<String, Object> additionalParameters)
        ...
        final Map<String, Object> aparams =
                additionalParameters == null ? new HashMap<String, Object>() : additionalParameters;
        OAuthToken token = oAuthApi.refreshTokenOAuthACG(
            getBasicAuthForClient(),
            getOAuthToken().getRefreshToken(),
            stringJoin(getOAuthScopes(), " "),
            aparams);
