 ...
 */
public class OAuthACGModel {
    private String oAuthClientId;
    private String oAuthClientSecret;
    private String oAuthRedirectUri;
    private OAuthToken oAuthToken;
    private List<OAuthScopeOAuthACGEnum> oAuthScopes;

    /**
     * A Constructor for OAuthACGModel.
     */
    private OAuthACGModel(String oAuthClientId, String oAuthClientSecret, String oAuthRedirectUri,
    ...
    /**
     * Builds a new {@link OAuthACGModel.Builder} object.
     * Creates the instance with the state of the current auth model.
     * @return a new {@link OAuthACGModel.Builder} object.
     */
    ...
    public static class Builder {
         ...
         * @return Builder The current instance of Builder.
         */
        public Builder oAuthScopes(List<OAuthScopeOAuthACGEnum> oAuthScopes) {
            this.oAuthScopes = oAuthScopes;
            return this;
        }

        /**
         * Builds the instance of OAuthACGModel using the provided credentials.
         * @return The instance of OAuthACGModel.
         */
        public OAuthACGModel build() {
            return new OAuthACGModel(oAuthClientId, oAuthClientSecret, oAuthRedirectUri, oAuthToken,
                    oAuthScopes);
        }
    }
}