 ...
 */
public class OAuthBearerTokenManager extends HeaderAuth implements OAuthBearerTokenCredentials {

    /**
     * Private instance of the auth model containing the auth credentials.
     */
    private OAuthBearerTokenModel authModel;

    /**
     * Constructor.
     * @param authModel The instance of auth credentials.
     */
    public OAuthBearerTokenManager(OAuthBearerTokenModel authModel) {
    ...
    /**
     * Converts this OAuthBearerTokenManager into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "OAuthBearerTokenManager [" + "accessToken=" + getAccessToken() + "]";
    }
    /**
    ...
    */
    ...
    public String getErrorMessage() {
        ...
        return "OAuthBearerToken - " + errorMessage;
    }
