 ...
 */
public class OAuthCCGManager extends HeaderAuth implements OAuthCCGCredentials {
     ...
     */
    private OAuthCCGModel authModel;
     ...
     * Constructor.
     */
    public OAuthCCGManager(OAuthCCGModel authModel) {
    ...
    */
    ...
    /**
     * Converts this OAuthCCGManager into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "OAuthCCGManager [" + "oAuthClientId=" + getOAuthClientId() + ", oAuthClientSecret="
                + getOAuthClientSecret() + ", oAuthToken=" + getOAuthToken() + "]";
    }
    ...
    public CompletableFuture<OAuthToken> fetchTokenAsync(
        ...
        return oAuthApi.requestTokenOAuthCCGAsync(
    ...
    public OAuthToken fetchToken(Map<String, Object> additionalParameters)
        ...
        OAuthToken token = oAuthApi.requestTokenOAuthCCG(
            getBasicAuthForClient(),
            null,
            aparams);
