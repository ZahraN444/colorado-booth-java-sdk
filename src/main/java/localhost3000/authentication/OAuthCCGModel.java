 ...
 */
public class OAuthCCGModel {
    private String oAuthClientId;
    private String oAuthClientSecret;
    private OAuthToken oAuthToken;
    private BiFunction<OAuthToken, OAuthCCGCredentials, OAuthToken> oAuthTokenProvider;
    private Consumer<OAuthToken> oAuthOnTokenUpdate;
    private long oAuthClockSkew;

    /**
     * A Constructor for OAuthCCGModel.
     */
    private OAuthCCGModel(String oAuthClientId, String oAuthClientSecret, OAuthToken oAuthToken,
            BiFunction<OAuthToken, OAuthCCGCredentials, OAuthToken> oAuthTokenProvider,
     ...
     */
    public BiFunction<OAuthToken, OAuthCCGCredentials, OAuthToken> getOAuthTokenProvider() {
    ...
    /**
     * Builds a new {@link OAuthCCGModel.Builder} object.
     * Creates the instance with the state of the current auth model.
     * @return a new {@link OAuthCCGModel.Builder} object.
     */
    ...
    public static class Builder {
         ...
         * @return Builder The current instance of Builder.
         */
        public Builder oAuthTokenProvider(BiFunction<OAuthToken, OAuthCCGCredentials, OAuthToken> oAuthTokenProvider) {
            this.oAuthTokenProvider = oAuthTokenProvider;
            return this;
        }
        ...
        /**
         * Builds the instance of OAuthCCGModel using the provided credentials.
         * @return The instance of OAuthCCGModel.
         */
        public OAuthCCGModel build() {
            return new OAuthCCGModel(oAuthClientId, oAuthClientSecret, oAuthToken,
